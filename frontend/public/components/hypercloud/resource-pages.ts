...
export const hyperCloudListPages = ImmutableMap<ResourceMapKey, ResourceMapValue>()
  ...
  //,FederatedDeploymentModel, FederatedIngressModel, FederatedNamespaceModel, FederatedJobModel, FederatedReplicaSetModel, FederatedSecretModel, FederatedServiceModel, FederatedPodModel