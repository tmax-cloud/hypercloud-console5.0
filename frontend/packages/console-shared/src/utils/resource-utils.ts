...
import { DeploymentConfigModel, ReplicationControllerModel, ReplicaSetModel, DeploymentModel, DaemonSetModel, StatefulSetModel, PodModel, SecretModel } from '@console/internal/models';
...
export const createSecretItems = (secrets: K8sResourceKind[], resources: any): OverviewItem[] => {
  const items = _.map(secrets, s => {
    const obj: K8sResourceKind = {
      ...s,
