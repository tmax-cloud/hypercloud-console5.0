...
import { DeploymentKind, K8sResourceKind, LabelSelector, PodKind, PodTemplate, RouteKind, apiVersionForModel, K8sKind, ObjectMetadata } from '@console/internal/module/k8s';
