...
import { createDaemonSetItems, createDeploymentConfigItems, createDeploymentItems, createPodItems, createStatefulSetItems, createSecretItems, getBuildConfigsForResource, getPodsForDeploymentConfigs, getPodsForDeployments, getReplicaSetsForResource, getRoutesForServices, getServicesForResource } from './resource-utils';
...
export class TransformResourceData {
  ...
  public createSecretItems = (secrets: K8sResourceKind[], operatorsFilter?: boolean): OverviewItem[] => createSecretItems(secrets, this.resources);
